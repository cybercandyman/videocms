...
infosoftglobal.FusionCharts.prototype = {
	...
	getSWFHTML: function() {
		...
		if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) { 
			...
			swfNode = '<embed type="application/x-shockwave-flash" src="'+ this.getAttribute('swf') +'?FUSIONCHARTS.COM" width="'+ this.getAttribute('width') +'" height="'+ this.getAttribute('height') +'"  ';
			...
			swfNode += '<param name="movie" value="'+ this.getAttribute('swf') +'?FUSIONCHARTS.COM" />';
			var params = this.getParams();
